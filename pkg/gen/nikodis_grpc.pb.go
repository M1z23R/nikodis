...
var CacheService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nikodis.CacheService",
	...
	Metadata: "nikodis.proto",
}

const (
	BrokerService_Publish_FullMethodName   = "/nikodis.BrokerService/Publish"
	BrokerService_Subscribe_FullMethodName = "/nikodis.BrokerService/Subscribe"
)
...
type BrokerServiceClient interface {
	...
	Subscribe(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SubscribeStream, Message], error)
}
...
func (c *brokerServiceClient) Subscribe(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SubscribeStream, Message], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &BrokerService_ServiceDesc.Streams[0], BrokerService_Subscribe_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeStream, Message]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BrokerService_SubscribeClient = grpc.BidiStreamingClient[SubscribeStream, Message]
...
type BrokerServiceServer interface {
	...
	Subscribe(grpc.BidiStreamingServer[SubscribeStream, Message]) error
...
func (UnimplementedBrokerServiceServer) Subscribe(grpc.BidiStreamingServer[SubscribeStream, Message]) error {
...
func _BrokerService_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BrokerServiceServer).Subscribe(&grpc.GenericServerStream[SubscribeStream, Message]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BrokerService_SubscribeServer = grpc.BidiStreamingServer[SubscribeStream, Message]

// BrokerService_ServiceDesc is the grpc.ServiceDesc for BrokerService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var BrokerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nikodis.BrokerService",
